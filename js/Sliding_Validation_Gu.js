...
(function($, window, document, undefined) {
	function SlidingValidation(append_obj, style, success) {
		...
		var style_wrapper = {
			...
			top: "0px",
			left: "0px",
			slide_block_wrapper_width: "275px",
			slide_block_wrapper_height: "30px",
			...
			default_text: "按住滑块向右拖动",
			default_text_color: "#555",
			success_text_color: "white",
			default_text_font_size: "13px",
			success_show_text: "验证成功",
			success_slider_wrapper_bg: "rgb(76,175,80)",
			success_url_icon: "image/sliding_block_image/ok.png",
			default_url_icon: "image/sliding_block_image/right-arrow.png",
